            ...
            return (
              <div key={memberEmail} className="flex items-center gap-3 bg-card rounded-xl p-3 border border-border">
                {profileByEmail[memberEmail]?.avatar_url ? (
                  ...
                  <div className="w-9 h-9 rounded-full bg-orange-100 flex items-center justify-center text-primary font-bold text-sm flex-shrink-0">
        ...
        <div className="bg-orange-50 rounded-xl p-4 border border-orange-200">
          ...
          <div className="flex rounded-xl border border-orange-200 overflow-hidden mb-3 bg-card">
            <button
              ...
              className={`flex-1 py-2 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors ${inviteMode === 'email' ? 'bg-primary text-white' : 'text-muted-foreground hover:bg-orange-50'}`}
            >
              <Mail className="w-3.5 h-3.5" /> Email
            </button>
            <button
              onClick={() => setInviteMode('phone')}
              className={`flex-1 py-2 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors ${inviteMode === 'phone' ? 'bg-primary text-white' : 'text-muted-foreground hover:bg-orange-50'}`}
            >
