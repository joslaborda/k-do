...
// Antes: página entera en inglés fijo, sin useTranslation — un usuario en
// español que aterrizaba en un 404 lo veía todo en inglés.
                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-foreground leading-relaxed">
                            {t('notFound.bodyPrefix')} <span className="font-medium text-foreground">"{pageName}"</span> {t('notFound.bodySuffix')}
                        </p>
                    </div>
                        ...
                        <div className="mt-8 p-4 bg-secondary rounded-lg border border-border">
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="text-left space-y-1">
                                    <p className="text-sm font-medium text-foreground">{t('notFound.adminNoteTitle')}</p>
                                    <p className="text-sm text-foreground leading-relaxed">
                                        {t('notFound.adminNoteBody')}
                                    </p>
                                </div>
                            </div>
                        </div>
